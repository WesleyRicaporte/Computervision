...
def main() -> None:
    ...
    img1 = read_image("hw1_pic1.jpg")  # wider image
    img2 = read_image("hw1_pic2.jpg")  # taller image
    ...
    img1_stats = calc_stats(img1_gray)  # [mean, std]
    ...
    cv2.imwrite("hw1_pic1_noise_red.jpg", img1_noise_red)
    cv2.imwrite("hw1_pic1_noise_green.jpg", img1_noise_green)
    cv2.imwrite("hw1_pic1_noise_blue.jpg", img1_noise_blue)

    cv2.imwrite("hw1_pic2_noise_red.jpg", img2_noise_red)
    cv2.imwrite("hw1_pic2_noise_green.jpg", img2_noise_green)
    cv2.imwrite("hw1_pic2_noise_blue.jpg", img2_noise_blue)

    cv2.imwrite("hw1_pic1_sp.jpg", img1_spnoise)
    cv2.imwrite("hw1_pic2_sp.jpg", img2_spnoise)

    cv2.imwrite("hw1_pic1_sp_blur.jpg", img_blur)
    cv2.imwrite("hw1_pic2_sp_blur.jpg", img2_blur)
